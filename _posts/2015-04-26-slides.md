...
description: "With limited time before the Extensible Web Summit, I rolled my own presentation framework in a couple of hours using ES6 and Gulp, with live JS execution in slides."
categories: Blog
