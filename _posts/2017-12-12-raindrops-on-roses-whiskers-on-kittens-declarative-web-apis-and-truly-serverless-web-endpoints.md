...
1. You could use it between two web pages on the same machine — even a third party website!! E.g. Loading a third party web page in an iframe and use its Comlink-exposed API to control it.

1. You could use it between two machines with Comlink proxying the data over WebRTC.
...
[**Glitch**
*The community that helps you build the app or bot of your dreams*glitch.com](https://glitch.com/~comlink-template)
